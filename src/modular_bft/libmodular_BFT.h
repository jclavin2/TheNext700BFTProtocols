...
int MBFT_init_client(char *host_name, char *config_quorum, char *config_pbft,
		char *config_chain, char *conf_priv_pbft, short port_quorum, short port_pbft,
		short port_chain);
...
int MBFT_init_replica(char *host_name, char *conf_quorum, char *conf_pbft, char *conf_priv_pbft,
