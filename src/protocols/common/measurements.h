...
EXTERNED struct timeval entry_time[ENTRY_TIMES_SIZE];
EXTERNED bool entry_time_valid[ENTRY_TIMES_SIZE];
EXTERNED long long total_sum_sec[ENTRY_TIMES_SIZE];
EXTERNED long long total_sum_usec[ENTRY_TIMES_SIZE];
EXTERNED long long total_samples[ENTRY_TIMES_SIZE];
...
#define ENTRY_TIMES_SIZE 8
EXTERNED ticks entry_time[ENTRY_TIMES_SIZE];
EXTERNED bool entry_time_valid[ENTRY_TIMES_SIZE];
EXTERNED ticks total_sum_ticks[ENTRY_TIMES_SIZE];
EXTERNED long long total_samples[ENTRY_TIMES_SIZE];
