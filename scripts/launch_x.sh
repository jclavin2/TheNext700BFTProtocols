...
#NUMBER_OF_CLIENTS='80 120 160 200'
#NUMBER_OF_CLIENTS='20 40 80 100'
NUMBER_OF_CLIENTS='1 10 20 40 80 100 120 160 200'
NUMBER_OF_FAULTS='1'
#NUMBER_OF_CLIENTS='1 10 20 80 100 160 200 400 800'
#NUMBER_OF_CLIENTS='1 200 400 800 1000 1200 1500 1800 2000'
PERCS_OF_MALICIOUS='10 25 50 75'

REQUEST_SIZES="8 512 2048 256 4096"
#REQUEST_SIZES='256 4096'
REPLY_SIZES='8'
TIMES='0'
#TIMES='0 5 10 20 50 100 200 350 500'
PROTO=${1:-ring}
